    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    float resolution = fsSettings["PointCloudMapping.Resolution"];   //add
    ...
    mpPointCloudMapping=make_shared<PointCloudMapping>(resolution);   //add
...
void System::Shutdown()
{
    ...
    mpPointCloudMapping->shutdown();  //add
    /*if(mpViewer)
    {
