...
namespace ORB_SLAM3
{
    ...
    int ORBmatcher::SearchByProjection(Frame &F, const vector<MapPoint*> &vpMapPoints, const float th, const bool bFarPoints, const float thFarPoints)
    {
        ...
        // double mTimeORB_Mat = std::chrono::duration_cast<std::chrono::duration<double,std::milli> >(t2 - t1).count();
        // std::cout << "ORB matches cost 1 = " << mTimeORB_Mat << " milliseconds. " << endl;  //add
        // total_1=total_1+mTimeORB_Mat;
        // std::cout<<" total_1 = "<<total_1<<endl;
        return nmatches;
    }
    ...
    int ORBmatcher::SearchByBoW(KeyFrame* pKF,Frame &F, vector<MapPoint*> &vpMapPointMatches)
    {
        ...
        // std::chrono::steady_clock::time_point t2 = std::chrono::steady_clock::now();
        // double mTimeORB_Mat = std::chrono::duration_cast<std::chrono::duration<double,std::milli> >(t2 - t1).count();
        // std::cout << "ORB matches cost 2 = " << mTimeORB_Mat << " milliseconds. " << endl;  //add
        // total_2=total_2+mTimeORB_Mat;
        // std::cout<<" total_2 = "<<total_2<<endl;
        return nmatches;
    }
    ...
    int ORBmatcher::SearchByProjection(Frame &CurrentFrame, const Frame &LastFrame, const float th, const bool bMono)
    {
        ...
        // std::chrono::steady_clock::time_point t2 = std::chrono::steady_clock::now();
        // double mTimeORB_Mat = std::chrono::duration_cast<std::chrono::duration<double,std::milli> >(t2 - t1).count();
        // std::cout << "ORB matches cost 8 = " << mTimeORB_Mat << " milliseconds. " << endl;  //add
        // total_8=total_8+mTimeORB_Mat;
        // std::cout<<" total_8 = "<<total_8<<endl;
        return nmatches;
    }
